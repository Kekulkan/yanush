...
const OPENROUTER_CHAT_MODEL = "deepseek/deepseek-chat-v3-0324";     // DeepSeek V3 для ученика
const OPENROUTER_CHAT_FALLBACK = "deepseek/deepseek-chat-v3-0324"; // Тот же (DeepSeek стабильный)
const OPENROUTER_ANALYSIS_MODEL = "deepseek/deepseek-chat-v3-0324"; // Для комиссии
const OPENROUTER_GHOST_MODEL = "deepseek/deepseek-chat-v3-0324";    // Для суфлёра
const OPENROUTER_GM_MODEL = "deepseek/deepseek-chat-v3-0324";       // Для GM
