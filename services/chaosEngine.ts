...
export const buildDynamicPrompt = (
    ...
    ЛОГИКА СТРЕССА У АГРЕССОРА:
    ⚠️ Если ты хамишь и доминируешь — твой стресс ПАДАЕТ, а не растёт!
    - Успешная атака (учитель растерялся) → stress -5-10
    - Чувство контроля над ситуацией → stress -3-5
    - Стресс растёт только когда ты теряешь контроль или пугаешься
