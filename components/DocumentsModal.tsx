  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-slate-400 text-sm leading-relaxed whitespace-pre-wrap">
        ...
        <p><strong>1.10. Провайдеры LLM API</strong> — сторонние поставщики вычислительных мощностей и моделей машинного обучения (включая, но не ограничиваясь: OpenRouter, AITUNNEL, ProxyAPI и аналогичные сервисы, предоставляющие доступ к моделям Claude, Gemini, Mistral и другим), серверы которых могут располагаться за пределами Российской Федерации.</p>
        <p><strong>1.11. Политика конфиденциальности</strong> — отдельный документ, определяющий порядок сбора, обработки, хранения и защиты персональных данных Лицензиата, размещённый по адресу: https://yanush-sim.ru/privacy.</p>
        ...
        <p>7.1. Размер лицензионного вознаграждения за Пакеты сессий (Платные тарифы) указан в интерфейсе Платформы по адресу: https://yanush-sim.ru/#pricing. Лицензиар вправе изменять стоимость Пакетов сессий в одностороннем порядке. Изменение стоимости не распространяется на ранее оплаченные Пакеты.</p>
        <p>7.2. Оплата производится безналичным путём в форме 100% предоплаты через платёжные инструменты, интегрированные в Платформу.</p>
        <p>7.3. Обязательство Лицензиара по предоставлению доступа к оплаченному Пакету сессий считается исполненным в момент зачисления соответствующего количества Сессий на баланс Личного кабинета Лицензиата.</p>
        <p>7.4. Срок использования оплаченных Сессий. Оплаченные Сессии доступны для использования в течение 12 (двенадцати) месяцев с момента зачисления на баланс, если иное не указано в описании конкретного Пакета. По истечении указанного срока неиспользованные оплаченные Сессии сгорают без компенсации, о чём Лицензиар уведомляет Лицензиата по электронной почте не менее чем за 14 (четырнадцать) дней до истечения срока.</p>
        <p>7.5. Условия возврата денежных средств.<br/>
        7.5.1. Предметом настоящего Договора является предоставление права использования программы для ЭВМ (ст. 1235 ГК РФ). Результат предоставления лицензии потребляется Лицензиатом в момент запуска каждой Сессии.<br/>
        7.5.2. Совершая оплату, Лицензиат подтверждает своё согласие на немедленное предоставление доступа к функциональности Платформы и осведомлённость об утрате права на отказ от исполнения Договора в части использованных Сессий.<br/>
        7.5.3. Возврат лицензионного вознаграждения за использованные Сессии не производится.<br/>
        7.5.4. В случае если Лицензиат — физическое лицо (потребитель) — заявляет отказ от Договора в порядке ст. 32 Закона РФ «О защите прав потребителей» до использования всех оплаченных Сессий, Лицензиар возвращает стоимость неиспользованных Сессий за вычетом фактически понесённых расходов (в том числе комиссий платёжных систем) в течение 10 (десяти) рабочих дней с момента получения заявления.<br/>
        7.5.5. Лицензиатам — юридическим лицам и индивидуальным предпринимателям — возврат неиспользованных Сессий осуществляется в порядке, согласованном Сторонами путём обмена письмами по электронной почте.</p>
        <p>7.6. Кассовый чек. Лицензиар формирует электронный кассовый чек (как плательщик НПД) и направляет его Лицензиату на адрес электронной почты, указанный при регистрации, или предоставляет ссылку на чек в интерфейсе Платформы.</p>
        <p>7.7. Промокоды и бонусные Сессии. Лицензиар вправе предоставлять Лицензиату промокоды для начисления бонусных Сессий. Бонусные Сессии:<br/>
