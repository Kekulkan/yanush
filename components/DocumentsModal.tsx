  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-slate-400 text-sm leading-relaxed whitespace-pre-wrap">
        ...
        <p><strong>1.10. Политика конфиденциальности</strong> — отдельный документ, определяющий порядок сбора, обработки, хранения и защиты персональных данных Лицензиата, размещённый по адресу: https://yanush-sim.ru/privacy.</p>
