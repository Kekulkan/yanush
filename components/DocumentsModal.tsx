  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-slate-400 text-sm leading-relaxed whitespace-pre-wrap pb-10">
        ...
        а) Согласие субъекта ПДн (при Акцепте <button onClick={() => setActiveDocId('terms')} className="text-blue-400 hover:underline">Оферты</button>).<br/>
        ...
        <p>13.3. В случае противоречия между настоящей Политикой и <button onClick={() => setActiveDocId('terms')} className="text-blue-400 hover:underline">Офертой</button> в вопросах обработки персональных данных приоритет имеет настоящая Политика как специальный документ.</p>
      </div>
    )
  },
  {
